...
data-affecting logic such as fetching, parsing, normalization, conversion,
freshness handling, and other constitution-governed risk areas. Add other tests
whenever they materially reduce delivery risk.
...
- [ ] T008 Configure error handling, stale-data policy, and logging infrastructure
- [ ] T009 Setup environment configuration management
- [ ] T010 [P] Establish shared provider client, normalization, and conversion utilities
...
- [ ] T013 [P] [US1] Unit test for parsing, unit normalization, or currency conversion logic
...
- [ ] T018 [US1] Add source labels, timestamps, and degraded-state messaging
- [ ] T019 [US1] Add validation, error handling, and observability for user story 1 operations
...
- [ ] T022 [P] [US2] Unit test for source fallback, staleness handling, or conversion rules
...
- [ ] T029 [P] [US3] Unit test for any new parsing, conversion, or freshness logic
...
- [ ] TXXX Verify source attribution, timestamps, disclaimers, and stale-state UX
